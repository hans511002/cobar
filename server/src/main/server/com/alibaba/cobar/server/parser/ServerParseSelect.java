...
public final class ServerParseSelect {
	 ...
	 * 
	 * @param offset
	 *            index of first ' ' after LAST_INSERT_ID(), offset == stmt.length() is possible
	 ...
	 * @return index after identity or `identity` or "identity" or 'identity', might equals to length. -1 if not
	 *         identity or `identity` or "identity" or 'identity'
	 */
